...
class DetailUI(Ui_mainWindow,QMainWindow,Write,Template,Init):
    ...
    def getFile(self):
        ...
        try:
            ...
            self.analyJSON.setEnabled(True)
            self.dtailReport.setEnabled(True)
            self.html.setEnabled(True)
            self.dtailLog.setEnabled(True)
            self.qSheetName.setEnabled(True)
    ...
    def sendEmail(self,htmlReportName):
        ...
        if isMail==2:
            ...
            try:
                ...
                yag.send(email[3],email[4],email[5],[htmlReportName])
