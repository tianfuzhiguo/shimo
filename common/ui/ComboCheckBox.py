...
class ComboCheckBox(QComboBox):
    ...
    def __init__(self):
        ...
        self.items = []
        self.row_num = 0
        self.setStyleSheet("border: 1px solid CornflowerBlue; border-radius: 3px;height:23px;background-color:#ffffff;")
    ...
    def loadItems(self, items):
        ...
        self.setStyleSheet(
            "QAbstractItemView::item {height: 18px;} QScrollBar::vertical{width:0px;border:none;border-radius:5px;}")
