...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background:WhiteSmoke")
        ...
        self.qSheetName.setStyleSheet("border: 1px solid CornflowerBlue; border-radius: 3px;height:23px;background-color:#ffffff;")
        ...
        self.fileName.setStyleSheet("border: 1px solid CornflowerBlue; border-radius: 3px;height:23px;background-color:#ffffff;")
        self.fileName.setObjectName("fileName")
        self.gridLayout.addWidget(self.fileName, 0, 0, 1, 2)
        self.checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox.setMinimumSize(QtCore.QSize(0, 25))
        self.checkBox.setStyleSheet("background-color:#ffffff;")
...
"    box-shadow: inset 0 1px 0 #80B0FB;")
        ...
        self.gridLayout_2.addWidget(self.refresh, 0, 1, 1, 1)
...
"    box-shadow: inset 0 1px 0 #80B0FB;")
        ...
        self.gridLayout_2.addWidget(self.analyJSON, 1, 1, 1, 1)
        self.task = QtWidgets.QPushButton(self.centralwidget)
        self.task.setMinimumSize(QtCore.QSize(0, 25))
        self.task.setStyleSheet("color: white;\n"
"    background: #5d8aad;\n"
"    border: 1px #3079ED solid;\n"
"    box-shadow: inset 0 1px 0 #80B0FB;")
        self.task.setObjectName("task")
        self.gridLayout_2.addWidget(self.task, 2, 0, 1, 1)
        self.abort = QtWidgets.QPushButton(self.centralwidget)
        self.abort.setMinimumSize(QtCore.QSize(0, 25))
        self.abort.setStyleSheet("color: white;\n"
"    background: #5d8aad;\n"
"    border: 1px #3079ED solid;\n"
"    box-shadow: inset 0 1px 0 #80B0FB;")
        ...
        self.taskTime.setMinimumSize(QtCore.QSize(0, 25))
        self.taskTime.setStyleSheet("border: 1px solid CornflowerBlue; border-radius: 3px;height:23px;background-color:#ffffff;")
        self.taskTime.setAlignment(QtCore.Qt.AlignCenter)
        self.taskTime.setObjectName("taskTime")
        self.gridLayout_2.addWidget(self.taskTime, 3, 0, 1, 2)
...
" ")
        ...
        self.gridLayout_3.addWidget(self.dtailReport, 3, 0, 1, 1)
...
"    box-shadow: inset 0 1px 0 #80B0FB;")
        ...
        self.gridLayout_3.addWidget(self.html, 3, 1, 1, 1)
...
"    box-shadow: inset 0 1px 0 #80B0FB;")
        ...
        self.gridLayout_3.addWidget(self.dtailLog, 3, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "发送邮件"))
        self.model1.setText(_translate("MainWindow", "普通"))
        self.model2.setText(_translate("MainWindow", "简洁"))
        ...
        self.analyJSON.setText(_translate("MainWindow", "解析"))
        ...
        self.label_9.setText(_translate("MainWindow", "成功"))
        self.label_7.setText(_translate("MainWindow", "失败"))
        self.label_8.setText(_translate("MainWindow", "异常"))
